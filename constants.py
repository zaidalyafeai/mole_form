...
column_options = {
    ...
    'Collection Style': 'crawling,human annotation,machine annotation,manual curation,LLM generated,other', # how were the examples/labels generated
    'Domain': 'social media,news articles,reviews,commentary,books,wikipedia,web pages,LLM,public datasets,TV Channels,captions,other', # what is the source of data
